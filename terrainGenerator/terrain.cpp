...
bool CTERRAIN::LoadHeightMap( char* szFilename, int iSize )
{
	...
	{
		//bad filename
        cout << "Falha ao carregar arquivo " << szFilename<<"\n" <<  endl;
		return false;
	}
	...
	if( m_heightData.m_ucpData==NULL )
	{
        ...
        cout << "Falha ao alocar memoria para o heightMAP" << endl;
		return false;
	}
    ...
    cout << "HeightMAP carregado com sucesso!" << endl;
	return true;
}
...
bool CTERRAIN::SaveHeightMap( char* szFilename )
{
	...
	{
		//bad filename
        cout << "Falha ao criar arquivo: " <<  szFilename << endl;
		return false;
	}
	...
	if( m_heightData.m_ucpData==NULL )
	{
        ...
        cout << "heightMAP data está vazio, falha ao gerar arquivo: "<< szFilename << endl;
		return false;
	}
	...
	cout << "Arquivo " << szFilename << " gerado com sucesso." << endl;
	return true;
}
...
bool CTERRAIN::UnloadHeightMap( void )
{
	...
	cout << "HeightMAP descarregado com sucesso" << endl;
	return true;
}
...
bool CTERRAIN::MakeTerrainFault( int iSize, int iIterations, int iMinDelta, int iMaxDelta, float fFilter )
{
	...
	{
		//something is seriously wrong here
		cout << "Falha ao alocar memorio para o heighMAP maketerrainfault" << endl;
		return false;
	}
	...
	{
		//something is seriously wrong here
		cout << "memoria não alocada corretamente para o heightMAP maketerrainfault" << endl;
		return false;
	}
...
bool CTERRAIN::MakeTerrainPlasma( int iSize, float fRoughness )
{
	...
	{
		//something is seriously wrong here
		cout << "Falha ao alocar memorio para o heighMAP maketerrainplasma" << endl;
		return false;
	}
	...
	{
		//something is seriously wrong here
		cout << "memoria não alocada corretamente para o heightMAP maketerrainplasma" << endl;
		return false;
	}
